cd /home/abduragim/projects/tracking/nntool_inference/inference_gvsoc_240x320_int
...
make -C /home/abduragim/projects/tracking/nntool_inference/inference_gvsoc_240x320_int  model PMSIS_OS=freertos MODEL_GEN_AT_LOGLEVEL=0
retVal=$?
if [ $retVal -ne 0 ]; then
    exit $retVal
fi
make -C /home/abduragim/projects/tracking/nntool_inference/inference_gvsoc_240x320_int -j 12 all platform=gvsoc PMSIS_OS=freertos MODEL_GEN_AT_LOGLEVEL=0
retVal=$?
if [ $retVal -ne 0 ]; then
    exit $retVal
fi
make -C /home/abduragim/projects/tracking/nntool_inference/inference_gvsoc_240x320_int run platform=gvsoc PMSIS_OS=freertos
exit $?
