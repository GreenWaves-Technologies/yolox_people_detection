...
#define GRAPH
    ...
    CreateGraph("mainCNN",
        /* Arguments either passed or globals */
            CArgs(586,
                ...
                // no activation -  IN1SCALE: [1] IN1SCALEN: [0] OUTSCALE: [173] OUTSCALEN: [8] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [95] IN1SCALEN: [6] OUTSCALE: [61] OUTSCALEN: [7] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [135] IN1SCALEN: [6] OUTSCALE: [171] OUTSCALEN: [9] ADD_BIAS: 0
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -2.02<(u8-86.00)*0.02349083<3.97
                ...
                // in q: -2.02<(u8-86.00)*0.02349083<3.97 out_q: -6.47<(u8-120.00)*0.05391617<7.28
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -6.47<(u8-120.00)*0.05391617<7.28
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -2.12<(u8-174.00)*0.01218221<0.99
                ...
                // in q: -2.12<(u8-174.00)*0.01218221<0.99 out_q: -6.47<(u8-120.00)*0.05391617<7.28
                ...
                // in q: -6.47<(u8-120.00)*0.05391617<7.28 out_q: f32
    ...
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.05298247<13.51 forced scaled input 0 is node input 1
    ...
    // Node S65_Conv2d_32x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.05298247<13.51 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S72_MatAdd_30x40x32 in1q 0.00<(u8-0.00)*0.05298247<13.51 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    ...
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.03486457<8.89 forced scaled input 0 is node input 0
    ...
    // Node S101_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.03486457<8.89 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S108_MatAdd_15x20x64 in1q 0.00<(u8-0.00)*0.03486457<8.89 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.04946670<12.61 forced scaled input 0 is node input 1
    ...
    // Node S111_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.04946670<12.61 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S118_MatAdd_15x20x64 in1q 0.00<(u8-0.00)*0.04946670<12.61 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    ...
    // Node Concat_381_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -2.02<(u8-86.00)*0.02349083<3.97
    ...
    // Node S298_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -2.02<(u8-86.00)*0.02349083<3.97 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node Concat_381_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -2.02<(u8-86.00)*0.02349083<3.97
    ...
    // Node Concat_381 inq ['-2.02<(u8-86.00)*0.02349083<3.97', '-2.02<(u8-86.00)*0.02349083<3.97', '-2.02<(u8-86.00)*0.02349083<3.97'] outq ['-2.02<(u8-86.00)*0.02349083<3.97']
    AddNode("S303_Concat",
        Bindings(4,
    ...
    // Node Concat_490_qin0 inq -2.02<(u8-86.00)*0.02349083<3.97 outq -6.47<(u8-120.00)*0.05391617<7.28
    ...
    // Node Concat_423_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -6.47<(u8-120.00)*0.05391617<7.28
    ...
    // Node S339_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -6.47<(u8-120.00)*0.05391617<7.28 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node Concat_423_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -6.47<(u8-120.00)*0.05391617<7.28
    ...
    // Node Concat_423 inq ['-6.47<(u8-120.00)*0.05391617<7.28', '-6.47<(u8-120.00)*0.05391617<7.28', '-6.47<(u8-120.00)*0.05391617<7.28'] outq ['-6.47<(u8-120.00)*0.05391617<7.28']
    AddNode("S344_Concat",
        Bindings(4,
    ...
    // Node Concat_465_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -2.12<(u8-174.00)*0.01218221<0.99
    ...
    // Node S379_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -2.12<(u8-174.00)*0.01218221<0.99 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node Concat_465_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -2.12<(u8-174.00)*0.01218221<0.99
    ...
    // Node Concat_465 inq ['-2.12<(u8-174.00)*0.01218221<0.99', '-2.12<(u8-174.00)*0.01218221<0.99', '-2.12<(u8-174.00)*0.01218221<0.99'] outq ['-2.12<(u8-174.00)*0.01218221<0.99']
    AddNode("S384_Concat",
        Bindings(4,
    ...
    // Node Concat_490_qin2 inq -2.12<(u8-174.00)*0.01218221<0.99 outq -6.47<(u8-120.00)*0.05391617<7.28
    ...
    // Node output_1_qin0 inq -6.47<(u8-120.00)*0.05391617<7.28 outq f32
