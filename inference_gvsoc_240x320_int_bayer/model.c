...
void mainModel(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_ConvolutionNE16("S4_Conv2d_16x4x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        4, 16, 160, 120,
    ...
    CNN_ConvolutionNE16("S307_Conv2d_64x128x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        128, 64, 20, 15,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S310_Conv2d_64x1x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 20, 15,
                        KOP_CONV_DW, 3, 3, 1, 1, 1, 1, 1, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S313_Conv2d_64x64x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 20, 15,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S316_Conv2d_64x1x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 20, 15,
                        KOP_CONV_DW, 3, 3, 1, 1, 1, 1, 1, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S319_Conv2d_64x64x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 20, 15,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S322_Conv2d_1x64x1x1_Sigmoid", 0,
                        -1, -1, 4, 1, 8,
                        64, 1, 20, 15,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_Convert("S323_Op_Concat_423_qin2", -1, -1, 300, KOP_CONVERT_FP_FP_SCALE);
    
    // generator for Conv_403_fusion
    CNN_ConvolutionNE16("S326_Conv2d_64x1x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 20, 15,
                        KOP_CONV_DW, 3, 3, 1, 1, 1, 1, 1, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S329_Conv2d_64x64x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 20, 15,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S332_Conv2d_64x1x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 20, 15,
                        KOP_CONV_DW, 3, 3, 1, 1, 1, 1, 1, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S335_Conv2d_64x64x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 20, 15,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S338_Conv2d_4x64x1x1", 0,
                        -1, -1, 4, 1, 8,
                        64, 4, 20, 15,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S341_Conv2d_1x64x1x1_Sigmoid", 0,
                        -1, -1, 4, 1, 8,
                        64, 1, 20, 15,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_Convert("S342_Op_Concat_423_qin1", -1, -1, 300, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for Concat_423
    CNN_ConcatLastAxis_Generator("S343_Concat", 0, -1, 300, 4, 1, 1, 0, KOP_CONCAT);
    
    
    // generator for Concat_490_qin1
    CNN_Convert("S345_Op_Concat_490_qin1", -1, -1, 1800, KOP_CONVERT_FP_FP_SCALE);
...
#define GRAPH
    ...
    CreateGraph("mainCNN",
        /* Arguments either passed or globals */
            CArgs(586,
                ...
                // in: 0.03104 out: 0.03104  actscale: [1] actscalen: [0] a0: [0] b0: [193] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // no activation -  IN1SCALE: [1] IN1SCALEN: [0] OUTSCALE: [97] OUTSCALEN: [7] ADD_BIAS: 0
                ...
                // in: 0.05760 out: 0.05760  actscale: [1] actscalen: [0] a0: [0] b0: [104] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // no activation -  IN1SCALE: [1] IN1SCALEN: [0] OUTSCALE: [85] OUTSCALEN: [7] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [193] IN1SCALEN: [7] OUTSCALE: [65] OUTSCALEN: [7] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [63] IN1SCALEN: [5] OUTSCALE: [209] OUTSCALEN: [9] ADD_BIAS: 0
                ...
                // in: 0.06853 out: 0.06853  actscale: [1] actscalen: [0] a0: [0] b0: [88] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // no activation -  IN1SCALE: [1] IN1SCALEN: [0] OUTSCALE: [143] OUTSCALEN: [8] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [57] IN1SCALEN: [5] OUTSCALE: [63] OUTSCALEN: [7] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [65] IN1SCALEN: [5] OUTSCALE: [11] OUTSCALEN: [5] ADD_BIAS: 0
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -3.76<(u8-106.00)*0.03551030<5.29
                ...
                TCArgInfo("unsigned char * __restrict__", "S307_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S307_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S307_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S307_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02353 out: 0.02353  actscale: [1] actscalen: [0] a0: [0] b0: [255] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                TCArgInfo("signed char * __restrict__", "S307_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S307_Infos.tensor", 1, 1, 8, 0)),
                ...
                TCArgInfo("unsigned char * __restrict__", "S310_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S310_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S310_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S310_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02353 out: 0.02353  actscale: [1] actscalen: [0] a0: [0] b0: [255] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                TCArgInfo("signed char * __restrict__", "S310_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S310_Infos.tensor", 1, 1, 8, 0)),
                ...
                TCArgInfo("unsigned char * __restrict__", "S313_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S313_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S313_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S313_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02353 out: 0.02353  actscale: [1] actscalen: [0] a0: [0] b0: [255] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                TCArgInfo("signed char * __restrict__", "S313_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S313_Infos.tensor", 1, 1, 8, 0)),
                ...
                TCArgInfo("unsigned char * __restrict__", "S316_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S316_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S316_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S316_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02353 out: 0.02353  actscale: [1] actscalen: [0] a0: [0] b0: [255] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                TCArgInfo("signed char * __restrict__", "S316_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S316_Infos.tensor", 1, 1, 8, 0)),
                ...
                TCArgInfo("unsigned char * __restrict__", "S319_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S319_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S319_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S319_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02353 out: 0.02353  actscale: [1] actscalen: [0] a0: [0] b0: [255] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                TCArgInfo("signed char * __restrict__", "S319_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S319_Infos.tensor", 1, 1, 8, 0)),
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -1.72<(u8-92.00)*0.01872279<3.05
                ...
                TCArgInfo("unsigned char * __restrict__", "S329_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S329_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S329_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S329_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02353 out: 0.02353  actscale: [1] actscalen: [0] a0: [0] b0: [255] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                TCArgInfo("signed char * __restrict__", "S329_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S329_Infos.tensor", 1, 1, 8, 0)),
                ...
                TCArgInfo("unsigned char * __restrict__", "S341_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S341_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S341_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S341_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.00024 out: 0.00392  actscale: [255] actscalen: [15] a0: [0] b0: 0 c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                TCArgInfo("signed char * __restrict__", "S341_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S341_Infos.tensor", 1, 1, 8, 0)),
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -1.72<(u8-92.00)*0.01872279<3.05
                ...
                // in q: -1.72<(u8-92.00)*0.01872279<3.05 out_q: -3.76<(u8-106.00)*0.03551030<5.29
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -3.52<(u8-116.00)*0.03031154<4.21
                ...
                // in q: -3.52<(u8-116.00)*0.03031154<4.21 out_q: -3.76<(u8-106.00)*0.03551030<5.29
                ...
                // in q: -3.76<(u8-106.00)*0.03551030<5.29 out_q: f32
        ...
        CArgs(152,
            ...
            TCArgInfo("unsigned char * __restrict__", "S307_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S310_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S313_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S316_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S319_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S322_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            ...
            TCArgInfo("unsigned char * __restrict__", "S329_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S332_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S335_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S338_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S341_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
    ...
    AddStackedTensors("S387_Output", 3, "S303_Output", "S345_Output", "S386_Output");
    AddStackedTensors("S163_Output", 2, "S164_Output_0", AT_UnusedStackMember("Slice_213_unused", 2560));

    // Node S4_Conv2d_16x4x3x3_Relu6 inq 0.00<(u8-0.00)*0.61568630<157.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S4_Conv2d_16x4x3x3_Relu6",
        Bindings(7,
    ...
    // Node S16_Conv2d_16x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.03103614<7.91 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    //   outq 0.00<(u8-0.00)*0.03103614<7.91 forced scaled input 0 is node input 0
    ...
    // Node Concat_33 inq ['0.00<(u8-0.00)*0.03103614<7.91 forced', '0.00<(u8-0.00)*0.03103614<7.91 forced'] outq ['0.00<(u8-0.00)*0.03103614<7.91 forced']
    AddNode("S27_Concat",
        Bindings(3,
    ...
    // Node S30_Conv2d_32x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.03103614<7.91 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S42_Conv2d_32x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.05759790<14.69 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.03542319<9.03 forced scaled input 0 is node input 0
    ...
    // Node S55_Conv2d_32x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.03542319<9.03 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S62_MatAdd_30x40x32 in1q 0.00<(u8-0.00)*0.03542319<9.03 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.04624839<11.79 forced scaled input 0 is node input 1
    ...
    // Node S65_Conv2d_32x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.04624839<11.79 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S72_MatAdd_30x40x32 in1q 0.00<(u8-0.00)*0.04624839<11.79 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.05759790<14.69 forced scaled input 0 is node input 1
    ...
    // Node Concat_93 inq ['0.00<(u8-0.00)*0.05759790<14.69 forced', '0.00<(u8-0.00)*0.05759790<14.69 forced'] outq ['0.00<(u8-0.00)*0.05759790<14.69 forced']
    AddNode("S73_Concat",
        Bindings(3,
    ...
    // Node S76_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.05759790<14.69 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S88_Conv2d_64x128x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.06852999<17.48 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.04197766<10.70 forced scaled input 0 is node input 0
    ...
    // Node S101_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.04197766<10.70 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S108_MatAdd_15x20x64 in1q 0.00<(u8-0.00)*0.04197766<10.70 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.04781783<12.19 forced scaled input 0 is node input 1
    ...
    // Node S111_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.04781783<12.19 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S118_MatAdd_15x20x64 in1q 0.00<(u8-0.00)*0.04781783<12.19 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.06852999<17.48 forced scaled input 0 is node input 1
    ...
    // Node Concat_153 inq ['0.00<(u8-0.00)*0.06852999<17.48 forced', '0.00<(u8-0.00)*0.06852999<17.48 forced'] outq ['0.00<(u8-0.00)*0.06852999<17.48 forced']
    AddNode("S119_Concat",
        Bindings(3,
    ...
    // Node S122_Conv2d_128x128x1x1_Relu6 inq 0.00<(u8-0.00)*0.06852999<17.48 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S282_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.10<(u8-128.00)*0.00077452<0.10 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -39135.53<(i32-0.00)*0.00001822<39135.53
    ...
    // Node Concat_381_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -3.76<(u8-106.00)*0.03551030<5.29
    ...
    // Node S298_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -3.76<(u8-106.00)*0.03551030<5.29 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S301_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -1.16<(u8-128.00)*0.00910573<1.16 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -460103.91<(i32-0.00)*0.00021425<460103.91
    ...
    // Node Concat_381_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -3.76<(u8-106.00)*0.03551030<5.29
    ...
    // Node Concat_381 inq ['-3.76<(u8-106.00)*0.03551030<5.29', '-3.76<(u8-106.00)*0.03551030<5.29', '-3.76<(u8-106.00)*0.03551030<5.29'] outq ['-3.76<(u8-106.00)*0.03551030<5.29']
    AddNode("S303_Concat",
        Bindings(4,
    ...
    // Node S307_Conv2d_64x128x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S307_Conv2d_64x128x1x1_Relu6",
        Bindings(7,
            GNodeArg(GNA_IN, "S238_Output", 0),
            GNodeArg(GNA_IN, "Conv_382_weights", 0),
            GNodeArg(GNA_IN, "Constant__1505", 0),
            GNodeArg(GNA_OUT, "S307_Output", 0),
            GNodeArg(GNA_IN, "S307_Mul_scale", 0),
            GNodeArg(GNA_IN, "S307_Mul_shift", 0),
            GNodeArg(GNA_IN, "S307_Infos", 0)
        )
    );
    // Node S310_Conv2d_64x1x3x3_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S310_Conv2d_64x1x3x3_Relu6",
        Bindings(7,
            GNodeArg(GNA_IN, "S307_Output", 0),
            GNodeArg(GNA_IN, "Conv_386_weights", 0),
            GNodeArg(GNA_IN, "Constant__1508", 0),
            GNodeArg(GNA_OUT, "S310_Output", 0),
            GNodeArg(GNA_IN, "S310_Mul_scale", 0),
            GNodeArg(GNA_IN, "S310_Mul_shift", 0),
            GNodeArg(GNA_IN, "S310_Infos", 0)
        )
    );
    // Node S313_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S313_Conv2d_64x64x1x1_Relu6",
        Bindings(7,
    ...
    // Node S316_Conv2d_64x1x3x3_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S316_Conv2d_64x1x3x3_Relu6",
        Bindings(7,
            GNodeArg(GNA_IN, "S313_Output", 0),
    ...
    // Node S319_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S319_Conv2d_64x64x1x1_Relu6",
        Bindings(7,
    ...
    // Node S322_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.08<(u8-128.00)*0.00059538<0.08 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -30083.80<(i32-0.00)*0.00001401<30083.80
    AddNode("S322_Conv2d_1x64x1x1_Sigmoid",
        Bindings(7,
    ...
    // Node Concat_423_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -1.72<(u8-92.00)*0.01872279<3.05
    AddNode("S323_Op_Concat_423_qin2",
        Bindings(3,
    ...
    // Node S326_Conv2d_64x1x3x3_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S326_Conv2d_64x1x3x3_Relu6",
        Bindings(7,
            GNodeArg(GNA_IN, "S307_Output", 0),
    ...
    // Node S329_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S329_Conv2d_64x64x1x1_Relu6",
        Bindings(7,
            GNodeArg(GNA_IN, "S326_Output", 0),
            GNodeArg(GNA_IN, "Conv_407_weights", 0),
            GNodeArg(GNA_IN, "Constant__1523", 0),
            GNodeArg(GNA_OUT, "S329_Output", 0),
            GNodeArg(GNA_IN, "S329_Mul_scale", 0),
            GNodeArg(GNA_IN, "S329_Mul_shift", 0),
            GNodeArg(GNA_IN, "S329_Infos", 0)
        )
    );
    // Node S332_Conv2d_64x1x3x3_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S332_Conv2d_64x1x3x3_Relu6",
        Bindings(7,
            GNodeArg(GNA_IN, "S329_Output", 0),
    ...
    // Node S335_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S335_Conv2d_64x64x1x1_Relu6",
        Bindings(7,
    ...
    // Node S338_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -1.72<(u8-92.00)*0.01872279<3.05 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S338_Conv2d_4x64x1x1",
        Bindings(7,
    ...
    // Node S341_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.84<(u8-128.00)*0.00665007<0.84 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -336021.48<(i32-0.00)*0.00015647<336021.48
    AddNode("S341_Conv2d_1x64x1x1_Sigmoid",
        Bindings(7,
            GNodeArg(GNA_IN, "S335_Output", 0),
            GNodeArg(GNA_IN, "Conv_420_weights", 0),
            GNodeArg(GNA_IN, "Constant_head_obj_preds_1_bias", 0),
            GNodeArg(GNA_OUT, "S341_Output", 0),
            GNodeArg(GNA_IN, "S341_Mul_scale", 0),
            GNodeArg(GNA_IN, "S341_Mul_shift", 0),
            GNodeArg(GNA_IN, "S341_Infos", 0)
        )
    );
    // Node Concat_423_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -1.72<(u8-92.00)*0.01872279<3.05
    AddNode("S342_Op_Concat_423_qin1",
        Bindings(3,
    ...
    // Node Concat_423 inq ['-1.72<(u8-92.00)*0.01872279<3.05', '-1.72<(u8-92.00)*0.01872279<3.05', '-1.72<(u8-92.00)*0.01872279<3.05'] outq ['-1.72<(u8-92.00)*0.01872279<3.05']
    AddNode("S343_Concat",
        Bindings(4,
    ...
    // Node Concat_490_qin1 inq -1.72<(u8-92.00)*0.01872279<3.05 outq -3.76<(u8-106.00)*0.03551030<5.29
    AddNode("S345_Op_Concat_490_qin1",
        Bindings(3,
    ...
    // Node S363_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.15<(u8-128.00)*0.00121410<0.15 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -61347.41<(i32-0.00)*0.00002857<61347.41
    ...
    // Node Concat_465_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -3.52<(u8-116.00)*0.03031154<4.21
    ...
    // Node S379_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -3.52<(u8-116.00)*0.03031154<4.21 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S382_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.87<(u8-128.00)*0.00687518<0.87 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -347396.16<(i32-0.00)*0.00016177<347396.16
    ...
    // Node Concat_465_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -3.52<(u8-116.00)*0.03031154<4.21
    ...
    // Node Concat_465 inq ['-3.52<(u8-116.00)*0.03031154<4.21', '-3.52<(u8-116.00)*0.03031154<4.21', '-3.52<(u8-116.00)*0.03031154<4.21'] outq ['-3.52<(u8-116.00)*0.03031154<4.21']
    AddNode("S384_Concat",
        Bindings(4,
    ...
    // Node Concat_490_qin2 inq -3.52<(u8-116.00)*0.03031154<4.21 outq -3.76<(u8-106.00)*0.03551030<5.29
    ...
    // Node output_1_qin0 inq -3.76<(u8-106.00)*0.03551030<5.29 outq f32
