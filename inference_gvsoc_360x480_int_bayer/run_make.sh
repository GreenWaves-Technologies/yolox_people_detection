cd /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE_less_ram
...
mkdir -p /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE_less_ram/build
retVal=$?
if [ $retVal -ne 0 ]; then
    exit $retVal
fi
(cd /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE_less_ram/build; cmake ..)
retVal=$?
if [ $retVal -ne 0 ]; then
    exit $retVal
fi
(cd /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE_less_ram/build; make -j  all )
retVal=$?
if [ $retVal -ne 0 ]; then
    exit $retVal
fi
(cd /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE_less_ram/build; make run )
exit $?
