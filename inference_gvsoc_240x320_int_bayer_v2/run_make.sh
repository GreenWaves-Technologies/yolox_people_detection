cd /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE
...
mkdir -p /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE/build
retVal=$?
if [ $retVal -ne 0 ]; then
    exit $retVal
fi
(cd /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE/build; cmake ..)
retVal=$?
if [ $retVal -ne 0 ]; then
    exit $retVal
fi
(cd /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE/build; make -j  all )
retVal=$?
if [ $retVal -ne 0 ]; then
    exit $retVal
fi
(cd /home/abduragim/projects/tracking/nntool_inference/GVSOC_INFERENCE_TEMPLATE/build; make run )
exit $?
