...
void mainModel(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_Convert("S346_Op_Concat_490_qin1", -1, -1, 1800, KOP_CONVERT_FP_FP_SCALE);
    
    // generator for Conv_424_fusion
    CNN_ConvolutionNE16("S349_Conv2d_64x256x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        256, 64, 10, 8,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S352_Conv2d_64x1x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 10, 8,
                        KOP_CONV_DW, 3, 3, 1, 1, 1, 1, 1, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S355_Conv2d_64x64x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 10, 8,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S358_Conv2d_64x1x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 10, 8,
                        KOP_CONV_DW, 3, 3, 1, 1, 1, 1, 1, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S361_Conv2d_64x64x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 10, 8,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S364_Conv2d_1x64x1x1_Sigmoid", 0,
                        -1, -1, 4, 1, 8,
                        64, 1, 10, 8,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_Convert("S365_Op_Concat_465_qin2", -1, -1, 80, KOP_CONVERT_FP_FP_SCALE);
    
    // generator for Conv_445_fusion
    CNN_ConvolutionNE16("S368_Conv2d_64x1x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 10, 8,
                        KOP_CONV_DW, 3, 3, 1, 1, 1, 1, 1, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S371_Conv2d_64x64x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 10, 8,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S374_Conv2d_64x1x3x3_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 10, 8,
                        KOP_CONV_DW, 3, 3, 1, 1, 1, 1, 1, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S377_Conv2d_64x64x1x1_Relu6", 0,
                        -1, -1, 4, 1, 8,
                        64, 64, 10, 8,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S380_Conv2d_4x64x1x1", 0,
                        -1, -1, 4, 1, 8,
                        64, 4, 10, 8,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_ConvolutionNE16("S383_Conv2d_1x64x1x1_Sigmoid", 0,
                        -1, -1, 4, 1, 8,
                        64, 1, 10, 8,
                        KOP_CONV, 1, 1, 1, 1, 1, 1, 0, 0,
                        KOP_NONE, 0, 0, 0, 0, 0, 0, 0,
    ...
    CNN_Convert("S384_Op_Concat_465_qin1", -1, -1, 80, KOP_CONVERT_FP_FP_SCALE);
    
    
    // generator for Concat_465
    CNN_ConcatLastAxis_Generator("S385_Concat", 0, -1, 80, 4, 1, 1, 0, KOP_CONCAT);
...
#define GRAPH
    ...
    CreateGraph("mainCNN",
        /* Arguments either passed or globals */
            CArgs(586,
                ...
                // in: 0.03979 out: 0.03979  actscale: [1] actscalen: [0] a0: [0] b0: [151] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // no activation -  IN1SCALE: [1] IN1SCALEN: [0] OUTSCALE: [151] OUTSCALEN: [8] ADD_BIAS: 0
                ...
                // in: 0.05683 out: 0.05683  actscale: [1] actscalen: [0] a0: [0] b0: [106] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // no activation -  IN1SCALE: [211] IN1SCALEN: [7] OUTSCALE: [1] OUTSCALEN: [1] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [255] IN1SCALEN: [7] OUTSCALE: [53] OUTSCALEN: [7] ADD_BIAS: 0
                ...
                // in: 0.07419 out: 0.07419  actscale: [1] actscalen: [0] a0: [0] b0: [81] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // no activation -  IN1SCALE: [1] IN1SCALEN: [0] OUTSCALE: [67] OUTSCALEN: [7] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [245] IN1SCALEN: [7] OUTSCALE: [103] OUTSCALEN: [8] ADD_BIAS: 0
                ...
                // no activation -  IN1SCALE: [159] IN1SCALEN: [6] OUTSCALE: [81] OUTSCALEN: [8] ADD_BIAS: 0
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -2.46<(u8-94.00)*0.02611894<4.21
                ...
                // in q: -2.46<(u8-94.00)*0.02611894<4.21 out_q: -3.50<(u8-103.00)*0.03395460<5.16
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -3.76<(u8-117.00)*0.03209745<4.43
                ...
                // in q: -3.76<(u8-117.00)*0.03209745<4.43 out_q: -3.50<(u8-103.00)*0.03395460<5.16
                ...
                TCArgInfo("unsigned char * __restrict__", "S349_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S349_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S349_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S349_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02353 out: 0.02353  actscale: [1] actscalen: [0] a0: [0] b0: [255] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -3.50<(u8-103.00)*0.03395460<5.16
                TCArgInfo("signed char * __restrict__", "S365_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S365_Infos.tensor", 1, 1, 8, 0)),
                ...
                TCArgInfo("unsigned char * __restrict__", "S368_Mul_scale", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S368_Mul_scale.tensor", 1, 1, 8, 0)),
                TCArgInfo("signed char * __restrict__", "S368_Mul_shift", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S368_Mul_shift.tensor", 1, 1, 8, 0)),
                // in: 0.02353 out: 0.02353  actscale: [1] actscalen: [0] a0: [0] b0: [255] c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // in q: 0.00<(u8-0.00)*0.00392157<1.00 out_q: -3.50<(u8-103.00)*0.03395460<5.16
                TCArgInfo("signed char * __restrict__", "S384_Infos", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("S384_Infos.tensor", 1, 1, 8, 0)),
                // in q: -3.50<(u8-103.00)*0.03395460<5.16 out_q: f32
        ...
        CArgs(152,
            ...
            TCArgInfo("unsigned char * __restrict__", "S344_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            TCArgInfo("unsigned char * __restrict__", "S349_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
            ...
            TCArgInfo("unsigned char * __restrict__", "S365_Output", ARG_SCOPE_LOCAL, ARG_DIR_INOUT, AT_MEM_UNDEF, AT_MEM_UNDEF, 0),
    ...
    AddStackedTensors("S387_Output", 3, "S305_Output", "S346_Output", "S385_Output");
    AddStackedTensors("S163_Output", 2, "S164_Output_0", AT_UnusedStackMember("Slice_213_unused", 2560));

    // Node S4_Conv2d_16x12x3x3_Relu6 inq 0.00<(u8-0.00)*0.97254902<248.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S16_Conv2d_16x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.03978587<10.15 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    //   outq 0.00<(u8-0.00)*0.03978587<10.15 forced scaled input 0 is node input 0
    ...
    // Node Concat_33 inq ['0.00<(u8-0.00)*0.03978587<10.15 forced', '0.00<(u8-0.00)*0.03978587<10.15 forced'] outq ['0.00<(u8-0.00)*0.03978587<10.15 forced']
    AddNode("S27_Concat",
        Bindings(3,
    ...
    // Node S30_Conv2d_32x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.03978587<10.15 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S42_Conv2d_32x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.05683134<14.49 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.03870689<9.87 forced scaled input 0 is node input 0
    ...
    // Node S55_Conv2d_32x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.03870689<9.87 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S62_MatAdd_30x40x32 in1q 0.00<(u8-0.00)*0.03870689<9.87 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.04691479<11.96 forced scaled input 0 is node input 1
    ...
    // Node S65_Conv2d_32x32x1x1_Relu6 inq 0.00<(u8-0.00)*0.04691479<11.96 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S72_MatAdd_30x40x32 in1q 0.00<(u8-0.00)*0.04691479<11.96 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.05683134<14.49 forced scaled input 0 is node input 1
    ...
    // Node Concat_93 inq ['0.00<(u8-0.00)*0.05683134<14.49 forced', '0.00<(u8-0.00)*0.05683134<14.49 forced'] outq ['0.00<(u8-0.00)*0.05683134<14.49 forced']
    AddNode("S73_Concat",
        Bindings(3,
    ...
    // Node S76_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.05683134<14.49 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S88_Conv2d_64x128x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.07419303<18.92 forced biasesq chan<(i32-0.00)*chan<chan
    ...
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.04496003<11.46 forced scaled input 0 is node input 0
    ...
    // Node S101_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.04496003<11.46 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S108_MatAdd_15x20x64 in1q 0.00<(u8-0.00)*0.04496003<11.46 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.05860987<14.95 forced scaled input 0 is node input 1
    ...
    // Node S111_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.05860987<14.95 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S118_MatAdd_15x20x64 in1q 0.00<(u8-0.00)*0.05860987<14.95 forced
    //   in2q 0.00<(u8-0.00)*0.02352941<6.00 forced
    //   outq 0.00<(u8-0.00)*0.07419303<18.92 forced scaled input 0 is node input 1
    ...
    // Node Concat_153 inq ['0.00<(u8-0.00)*0.07419303<18.92 forced', '0.00<(u8-0.00)*0.07419303<18.92 forced'] outq ['0.00<(u8-0.00)*0.07419303<18.92 forced']
    AddNode("S119_Concat",
        Bindings(3,
    ...
    // Node S122_Conv2d_128x128x1x1_Relu6 inq 0.00<(u8-0.00)*0.07419303<18.92 forced weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S282_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.10<(u8-128.00)*0.00077893<0.10 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -39358.82<(i32-0.00)*0.00001833<39358.82
    ...
    // Node Concat_381_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -2.46<(u8-94.00)*0.02611894<4.21
    ...
    // Node S298_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -2.46<(u8-94.00)*0.02611894<4.21 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S301_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -1.06<(u8-128.00)*0.00836887<1.06 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -422870.92<(i32-0.00)*0.00019691<422870.92
    ...
    // Node Concat_381_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -2.46<(u8-94.00)*0.02611894<4.21
    ...
    // Node Concat_381 inq ['-2.46<(u8-94.00)*0.02611894<4.21', '-2.46<(u8-94.00)*0.02611894<4.21', '-2.46<(u8-94.00)*0.02611894<4.21'] outq ['-2.46<(u8-94.00)*0.02611894<4.21']
    AddNode("S303_Concat",
        Bindings(4,
    ...
    // Node Concat_490_qin0 inq -2.46<(u8-94.00)*0.02611894<4.21 outq -3.50<(u8-103.00)*0.03395460<5.16
    ...
    // Node S323_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.10<(u8-128.00)*0.00077368<0.10 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -39093.41<(i32-0.00)*0.00001820<39093.41
    ...
    // Node Concat_423_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -3.76<(u8-117.00)*0.03209745<4.43
    ...
    // Node S339_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -3.76<(u8-117.00)*0.03209745<4.43 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S342_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.87<(u8-128.00)*0.00686860<0.87 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -347063.44<(i32-0.00)*0.00016161<347063.44
    ...
    // Node Concat_423_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -3.76<(u8-117.00)*0.03209745<4.43
    ...
    // Node Concat_423 inq ['-3.76<(u8-117.00)*0.03209745<4.43', '-3.76<(u8-117.00)*0.03209745<4.43', '-3.76<(u8-117.00)*0.03209745<4.43'] outq ['-3.76<(u8-117.00)*0.03209745<4.43']
    AddNode("S344_Concat",
        Bindings(4,
    ...
    // Node Concat_490_qin1 inq -3.76<(u8-117.00)*0.03209745<4.43 outq -3.50<(u8-103.00)*0.03395460<5.16
    AddNode("S346_Op_Concat_490_qin1",
        Bindings(3,
    ...
    // Node S349_Conv2d_64x256x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S349_Conv2d_64x256x1x1_Relu6",
        Bindings(7,
            ...
            GNodeArg(GNA_IN, "S349_Mul_scale", 0),
            GNodeArg(GNA_IN, "S349_Mul_shift", 0),
            GNodeArg(GNA_IN, "S349_Infos", 0)
        )
    );
    // Node S352_Conv2d_64x1x3x3_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S352_Conv2d_64x1x3x3_Relu6",
        Bindings(7,
    ...
    // Node S355_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S355_Conv2d_64x64x1x1_Relu6",
        Bindings(7,
    ...
    // Node S358_Conv2d_64x1x3x3_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S358_Conv2d_64x1x3x3_Relu6",
        Bindings(7,
    ...
    // Node S361_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S361_Conv2d_64x64x1x1_Relu6",
        Bindings(7,
    ...
    // Node S364_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.10<(u8-128.00)*0.00082150<0.10 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -41509.84<(i32-0.00)*0.00001933<41509.84
    AddNode("S364_Conv2d_1x64x1x1_Sigmoid",
        Bindings(7,
    ...
    // Node Concat_465_qin2 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -3.50<(u8-103.00)*0.03395460<5.16
    AddNode("S365_Op_Concat_465_qin2",
        Bindings(3,
            GNodeArg(GNA_IN, "S364_Output", 0),
            GNodeArg(GNA_OUT, "S365_Output", 0),
            GNodeArg(GNA_IN, "S365_Infos", 0)
        )
    );
    // Node S368_Conv2d_64x1x3x3_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S368_Conv2d_64x1x3x3_Relu6",
        Bindings(7,
            GNodeArg(GNA_IN, "S349_Output", 0),
            GNodeArg(GNA_IN, "Conv_445_weights", 0),
            GNodeArg(GNA_IN, "Constant__1547", 0),
            GNodeArg(GNA_OUT, "S368_Output", 0),
            GNodeArg(GNA_IN, "S368_Mul_scale", 0),
            GNodeArg(GNA_IN, "S368_Mul_shift", 0),
            GNodeArg(GNA_IN, "S368_Infos", 0)
        )
    );
    // Node S371_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S371_Conv2d_64x64x1x1_Relu6",
        Bindings(7,
    ...
    // Node S374_Conv2d_64x1x3x3_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S374_Conv2d_64x1x3x3_Relu6",
        Bindings(7,
    ...
    // Node S377_Conv2d_64x64x1x1_Relu6 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.02352941<6.00 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S377_Conv2d_64x64x1x1_Relu6",
        Bindings(7,
    ...
    // Node S380_Conv2d_4x64x1x1 inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq chan<(u8-128.00)*chan<chan outq -3.50<(u8-103.00)*0.03395460<5.16 biasesq chan<(i32-0.00)*chan<chan
    AddNode("S380_Conv2d_4x64x1x1",
        Bindings(7,
    ...
    // Node S383_Conv2d_1x64x1x1_Sigmoid inq 0.00<(u8-0.00)*0.02352941<6.00 weightsq -0.85<(u8-128.00)*0.00668007<0.85 outq 0.00<(u8-0.00)*0.00392157<1.00 biasesq -337537.39<(i32-0.00)*0.00015718<337537.39
    AddNode("S383_Conv2d_1x64x1x1_Sigmoid",
        Bindings(7,
            GNodeArg(GNA_IN, "S377_Output", 0),
    ...
    // Node Concat_465_qin1 inq 0.00<(u8-0.00)*0.00392157<1.00 outq -3.50<(u8-103.00)*0.03395460<5.16
    AddNode("S384_Op_Concat_465_qin1",
        Bindings(3,
            GNodeArg(GNA_IN, "S383_Output", 0),
            GNodeArg(GNA_OUT, "S384_Output", 0),
            GNodeArg(GNA_IN, "S384_Infos", 0)
        )
    );
    // Node Concat_465 inq ['-3.50<(u8-103.00)*0.03395460<5.16', '-3.50<(u8-103.00)*0.03395460<5.16', '-3.50<(u8-103.00)*0.03395460<5.16'] outq ['-3.50<(u8-103.00)*0.03395460<5.16']
    AddNode("S385_Concat",
        Bindings(4,
            GNodeArg(GNA_IN, "S380_Output", 0),
            GNodeArg(GNA_IN, "S384_Output", 0),
            GNodeArg(GNA_IN, "S365_Output", 0),
            GNodeArg(GNA_OUT, "S385_Output", 0)
        )
    );
    // Node output_1_qin0 inq -3.50<(u8-103.00)*0.03395460<5.16 outq f32
